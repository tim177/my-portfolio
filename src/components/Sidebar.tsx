...
const SidebarHeader = () => {
  return (
    <div className="flex space-x-2">
      {" "}
      <Image
        src="https://avatars.githubusercontent.com/u/79762903?v=4"
        alt="avatar"
        height="40"
        width="40"
        className="object-cover object-top rounded-full flex flex-shrink-0"
      />
      <div className="flex text-sm flex-col">
        <p className="font-bold text-primary">Amit Singh</p>
